...
## Associated skills
Web Development, Debugging, Personal Computers, Data Science, Regular Expressions, Python (Programming Language), Web Browsers, C (Programming Language), SQL (Programming Language), Boolean Expression, Computer Science, JavaScript (Programming Language), Unit Testing
